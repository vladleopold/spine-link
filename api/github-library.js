  ...
  <head>
    ...
    <style>
      ...
      *::-webkit-scrollbar-thumb:hover { background: rgba(100,106,115,.78); background-clip: content-box; }
      ...
      .library-grid { display: block; column-count: 4; column-gap: 18px; }
      .library-card { position: relative; display: inline-block; width: 100%; height: auto; margin: 0 0 18px; overflow: hidden; break-inside: avoid; border: 2px solid rgba(255,185,214,.72); border-radius: 8px; color: inherit; background: radial-gradient(circle at 22% 22%, rgba(255,106,40,.28), transparent 36%), radial-gradient(circle at 78% 16%, rgba(140,199,255,.32), transparent 32%), linear-gradient(135deg, rgba(32,35,38,.98), rgba(20,22,25,.98)); box-shadow: 0 0 0 1px rgba(255,185,214,.2), 0 20px 56px rgba(0,0,0,.34); transition: transform 150ms ease, border-color 150ms ease; }
      .library-card--small-square { min-height: 260px; }
      .library-card--square { min-height: 360px; }
      .library-card--horizontal, .library-card--wide { min-height: 300px; }
      .library-card--vertical, .library-card--medium-narrow { min-height: 520px; }
      .library-card--medium-wide { min-height: 340px; }
      .library-card--large-rect { min-height: 500px; }
      .library-card--full { min-height: 430px; column-span: all; }
      ...
      .library-card-visual { position: relative; display: flex; align-items: flex-end; justify-content: space-between; min-height: clamp(190px, 58%, 420px); padding: 24px; color: #fff; background: linear-gradient(rgba(9,11,13,.05), rgba(9,11,13,.18)); overflow: hidden; }
      ...
      @media (max-width: 900px) { .library-grid { column-count: 2; } .library-card--full { column-span: none; } }
      @media (max-width: 640px) { * { scrollbar-width: none; } *::-webkit-scrollbar { width: 0; height: 0; display: none; } .creator-card { grid-template-columns: 1fr; gap: 22px; padding: 20px; } .creator-row { align-items: center; justify-self: stretch; flex-direction: row; gap: 14px; } .creator-avatar { width: clamp(44px, 15vw, 56px); height: clamp(44px, 15vw, 56px); } .creator-name-line { flex: 1 1 auto; min-width: 0; display: grid; grid-template-columns: minmax(0, max-content); column-gap: 40px; row-gap: 7px; } .creator-name { max-width: calc(100vw - 140px); font-size: clamp(18px, 6.2vw, 30px); white-space: nowrap; } .creator-count { font-size: clamp(14px, 4.4vw, 18px); } .library-grid { column-count: 1; } .library-card, .library-card--small-square, .library-card--square, .library-card--horizontal, .library-card--wide, .library-card--vertical, .library-card--medium-narrow, .library-card--medium-wide, .library-card--large-rect, .library-card--full { min-height: 340px; } }
    </style>
  </head>
